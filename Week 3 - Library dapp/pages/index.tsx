...
import LibraryModule from "../components/LibraryController";
import { ALBT_TOKEN_ADDRESS, LIBRARY_ADDRESS, US_ELECTION_ADDRESS } from "../constants";
      ...
      <main>
        ...
        {isConnected && (
          <section>
            ...
            <LibraryModule contractAddress={LIBRARY_ADDRESS} />
          </section>
        )}
      </main>
